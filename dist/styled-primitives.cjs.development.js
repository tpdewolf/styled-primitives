...
var getWidth = function getWidth(n, scale) {
  return styledSystem.get(scale, n, !isNumber(n) || n > 1 ? n : n * 100 + '%');
};
...
var boxStyles = /*#__PURE__*/styledSystem.compose(styledSystem.layout, styledSystem.color, styledSystem.space, styledSystem.background, styledSystem.border, styledSystem.grid, styledSystem.position, styledSystem.shadow, styledSystem.typography, styledSystem.flexbox, extraConfig);
var Box = /*#__PURE__*/styled__default.div({
...
var inset = /*#__PURE__*/styledSystem.style({
  prop: 'inset',
  cssProperty: 'marginLeft',
  transformValue: transformValue
});
var col = /*#__PURE__*/styledSystem.style({
  prop: 'col',
  cssProperty: 'width',
  transformValue: transformValue
});
var Column = /*#__PURE__*/styled__default(Box)( /*#__PURE__*/styledSystem.compose(col, inset));
Column.displayName = 'Column';

var Flex = /*#__PURE__*/styled__default(Box)({});
Flex.defaultProps = {
  display: 'flex'
};
...
var Grid = function Grid(props) {
  ...
  var themeContext = styled.useTheme();
...
var PseudoBox = /*#__PURE__*/styled__default(Box)(function (_ref) {
  var _css;
...
var StyledChildren = function StyledChildren(_ref) {
  ...
  var styledChildren = React.Children.toArray(children).filter(React.isValidElement).map(function (child) {
...
var Space = /*#__PURE__*/styled__default(StyledChildren)(styledSystem.space);
